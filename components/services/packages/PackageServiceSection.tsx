...
interface PackageService extends Service {
    city: string[];
}
...
export default function PackageServiceSection({ isEditing, serviceId, title }: ServiceSectionProps) {
    ...
    const handleInputChange = (key: keyof PackageService, value: any) => {
        if (key === "isActive") {
            setUpdatedService((prev) => ({
                ...prev,
                [key]: value,
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            {isEditing ? (
                                ...
                                <>
                                    <div className="flex items-center gap-3">
                                        <p className="mt-3">GST: {service?.tax?.GST || 0}%</p>
                                        <p className="mt-3">Vendor GST: {service?.tax?.vendorGST || 0}%</p>
                                    </div>
                                </>
                            )}
                        </div>

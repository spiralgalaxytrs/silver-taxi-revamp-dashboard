...
const ProfileForm = ({ id, createdBy }: ProfileFormProps) => {
    ...
    const [formData, setFormData] = useState<FormData>({
        ...
        customerReferral: { senderAmount: 0, receiverAmount: 0 },
        vendorReferral: { senderAmount: 0, receiverAmount: 0 },
    ...
    useEffect(() => {
        if (profile) {
            ...
            setFormData({
                ...
                customerReferral: profile.customerReferral || { senderAmount: 0, receiverAmount: 0 },
                vendorReferral: profile.vendorReferral || { senderAmount: 0, receiverAmount: 0 },
                        ...
                        <div className="space-y-6">
                                        ...
                                        {logoURL && (
                                            <>
                                                ...
                                                <div className="flex flex-col items-center">
                                                    <p className="text-gray-400 mt-2 text-center text-base text-wrap">
                                                        {formData.logo instanceof File ? formData.logo.name.slice(0, 50) + '...' : formData?.logo?.slice(0, 50) + '...'}
                                                    </p>
                            ...
                            <div>
                                ...
                                <Input
                                    ...
                                    className="w-full border-grey py-7 mt-1"
                                    value={formData.companyCommissionPercentage}
                                    onChange={(e) => handleInputChange('companyCommissionPercentage', e.target.value)}
                                />
                            </div>
                                        ...
                                        <div className="flex space-x-2 mt-2">
                                            <div className='flex flex-col gap-3'>
                                                ...
                                                <Input
                                                    ...
                                                    className="w-full border-grey py-7"
                                                    value={formData.customerReferral?.senderAmount}
                                                    onChange={(e) => handleInputChange('customerReferral.senderAmount', e.target.value)}
                                                />
                                            </div>
                                            <div className='flex flex-col gap-3'>

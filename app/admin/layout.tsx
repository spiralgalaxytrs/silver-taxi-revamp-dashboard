...
export default function AdminLayout({
  ...
  if (isAuthorized.token === '' || isAuthorized.role !== 'admin') {
    return <Unauthorized />;
  }
          ...
          <div className="flex h-screen bg-gray-100">
            ...
            <div className="flex flex-col flex-1 overflow-hidden">
              <header className="flex items-center justify-between px-6 py-5 bg-white border-b">
                <h1 className="text-2xl font-semibold text-gray-800 invisible pt-2">
                  Dashboard
                </h1>
              ...
              <main className="flex-1 overflow-x-hidden overflow-y-auto scrollbar-hide bg-gray-100">
